    ...
    state = {
        ...
        formControls: {
            email: {
                ...
                type: 'email',
                label: 'Email',
                errorMessage: 'Вы ввели неправильный email',
                valid: false,
                touched: false,
                validation: {
                    required: true,
            ...
            password: {
                ...
                type: 'password',
                label: 'Пароль',
                errorMessage: 'Вы ввели неправильный пароль',
                valid: false,
                touched: false,
                validation: {
                    required: true,
...
onChangeHandler = (event, controlName) => {
    ...
    control.valid = this.validationCheck(control.value, control.validation);
...
renderInputs = () => {
    return Object.keys(this.state.formControls).map((controlName, idx) => {
        ...
        return (
            <Input key={control + idx} type={control.type} label={control.label} 
